"""
Django settings for my_elearning_project project.
"""
...
SECRET_KEY = 'django-insecure-z*z9@$y8-00$s$v!s#r3k$z=p(y-37#r12z#*g@j3=1^k1h'
...
ROOT_URLCONF = 'my_elearning_project.urls'
...
WSGI_APPLICATION = 'my_elearning_project.wsgi.application'
